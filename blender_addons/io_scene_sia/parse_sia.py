...
def load(path: str):
    ...
    with open(path, "rb") as sia_file:
        ...
        read_utils.read_u32(sia_file)  # Version maybe?

        model.name = read_utils.read_string(sia_file)
        ...
        for i in range(meshes_num):
            ...
            for _ in range(mesh.triangles_num):
                ...
                if vertices_total_num > 65535:
                    triangle = data_types.read_triangle_u32(sia_file)
                else:
        ...
        if num == 75 or num == 215 or num == 10 or num == 212 or num == 255 or num == 34 or num == 221 or num == 114 or num == 70 or num == 198 or num == 40 or num == 104 or num == 220 or num == 252 or num == 87 or num == 102 or num == 129 or num == 183 or num == 216 or num == 223 or num == 225 or num == 233 or num == 245 or num == 254 or num == 5:
            ...
            num2 = read_utils.read_u8(sia_file)
        ...
        # TODO: These can be combined and concened a lot
            ...
            kind = read_utils.read_string_u8_len(sia_file)
            if kind == b"mesh_type":
                mesh_type = data_types.MeshType.from_u8(read_utils.read_u8(sia_file))
                if mesh_type == data_types.MeshType.VariableLength:
                    ...
                    read_utils.skip(sia_file, 4)
                    model.end_kind = data_types.EndKind.MeshType(
                        read_utils.read_string_u8_len(sia_file))
                    read_utils.skip(sia_file, 5)
                    read_file_end(sia_file, num)
                    return model
                elif mesh_type == data_types.MeshType.BodyPart:
                    model.end_kind = data_types.EndKind.MeshType(
                        read_utils.read_string_with_length(sia_file, 4))
                elif mesh_type == data_types.MeshType.RearCap:
                    model.end_kind = data_types.EndKind.MeshType(
                        read_utils.read_string_with_length(sia_file, 8))
                    num_caps = read_utils.read_u32(sia_file)
                    for _ in range(num_caps):
                        cap_type = read_utils.read_u32(sia_file)
                        read_utils.skip(sia_file, 80)
                    ...
                    model.end_kind = data_types.EndKind.MeshType(
                        read_utils.read_string_with_length(sia_file, 12))
                elif mesh_type == data_types.MeshType.Glasses:
                    model.end_kind = data_types.EndKind.MeshType(
                        read_utils.read_string_with_length(sia_file, 7))
                elif mesh_type == data_types.MeshType.PlayerTunnel:
                    model.end_kind = data_types.EndKind.MeshType(
                        read_utils.read_string_with_length(sia_file, 13))
                elif mesh_type == data_types.MeshType.SideCap:
                    model.end_kind = data_types.EndKind.MeshType(
                        read_utils.read_string_with_length(sia_file, 14))
                ...
                model.end_kind = data_types.EndKind.IsBanner(read_utils.read_u8(sia_file) != 0)
        ...
        for i in range(0, instances):
            ...
            name = read_utils.read_string(sia_file)
            path = read_utils.read_string(sia_file)
